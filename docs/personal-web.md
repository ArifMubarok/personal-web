...
- Duration (start - end): October 2024 - Present
...
- Role: Software Engineer
- Duration (start - end): February 2023 - June 2023
- Location: Solo, Indonesia
- Description / responsibilities: 
...
- Key achievements: 
- Technical Skills: PHP, Laravel, MySQL

## 5. Projects
Repeat this block for each project.

### Smart Edu-5P (Project Management App)
- Description: Managing task of 5P program, the app has 2 role, such as teacher and student. student can upload their task or even create task for the team, and then the teacher can see and verify.
- Tech stack: ExpressJS, React Native, VPS
- Role / contribution: 
...
- Link (demo/repo): repo:https://github.com/badaso404/smartedu5p

## 6. Education
- School/University: Sebelas Maret University, Surakarta
- Degree: D3 Teknik Informatika / Associate Degree in Informatics Engineering
- Duration: 4 years (i prefer not showed this up)
...
- Name / Issuer / Date: 
    - The Complete JavaScript Course 2023: From Zero to Expert! - Udemy - Issued Jun 2023
    - JavaScript Intermediate - Sololearn - Issued Jun 2023
    - Belajar Dasar Pemrograman JavaScript - Dicoding Indonesia - Issued May 2023 · Expired May 2026
    - Cloud Practitioner Essentials (Belajar Dasar AWS Cloud) - Dicoding Indonesia - Issued May 2023 · Expired May 2026
    - SQL Course - Sololearn - Issued Apr 2021
...
What do you want visitors to do? (e.g. "Let's connect", contact form, hire me, etc.)
Let's connect
...
- synced all content (work experience, skills, phone number) with updated CV (Arif_Rahman_Mubarok_Resume_3.pdf): IGCY's two roles merged into one (Oct 2024 - Present), company renamed "IGCY SG" → "IGCY", CV. Gudang Media Perkasa dates corrected to Feb - Jun 2023, added MongoDB to skills